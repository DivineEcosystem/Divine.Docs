import{a as t,b as s,c as d,d as o,e as l,g as u,p as c,w as f,y as m}from"./chunk-HKAKSKF2.min.js";var v=class extends m{static{t(this,"RailroadAbnfTokenBuilder")}constructor(){super(["railroad-abnf-beta"])}},b=class extends f{static{t(this,"RailroadAbnfValueConverter")}runConverter(r,e,a){let i=super.runConverter(r,e,a);if(r.name==="TITLE"&&typeof i=="string"){let n=i.trim();if(n.startsWith('"')&&n.endsWith('"')||n.startsWith("'")&&n.endsWith("'"))return n.slice(1,-1)}return i}runCustomConverter(r,e,a){if(r.name==="ABNF_STRING")return e.slice(1,-1)}},A={parser:{TokenBuilder:t(()=>new v,"TokenBuilder"),ValueConverter:t(()=>new b,"ValueConverter")}};function C(r=l){let e=o(d(r),u),a=o(s({shared:e}),c,A);return e.ServiceRegistry.register(a),{shared:e,RailroadAbnf:a}}t(C,"createRailroadAbnfServices");export{A as a,C as b};
//# sourceMappingURL=chunk-RJT23JEV.min.js.map
...
// SIG // ioD9IaY9uypgLoiFG8VgaFpYOts2bThEgL4OsG6k1kqg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAm8IZC
// SIG // TwMq+21Knu+k8oLU+4MXUA1nCEWODaw+blPPkDBUBgor
...
// SIG // AGzZ6/FnOLSMnSFN15greGF8VhEWqm5D2TxUO6iQBuD8
// SIG // 1Am9bl5Csi+9P09pCy0l1oyyIFbN1MAa2y8HJXlIX0rX
// SIG // j6pNOyHO5MclUIdrj+w0oP07N+KRn3Jy/lgg6+Dpvt34
// SIG // 7f415RW/XUNVXH3o8mwUlexjAOYufZJj20Rw4F0RlcYj
// SIG // zLpW1PegO0fV14r1MdOaF7I4tH9CwAGnqhtgx9xBJj16
// SIG // 4q9ZX0AL2wXNacPLTFX7b5cVSPR1NeISEuXcgWQg28hn
// SIG // pJOPIp1tg4QzWqGCv6Fp8ofodFjpRP/pyn6qi1dJTtTt
// SIG // 8Ic+Bay+nMxhd94NttwzQoHp90hLJZkU5LKrzWk8DLUr
// SIG // Fm/S+jCzx/OtuQmpCHry3Gm5eAedbD8ZX7ox+ht47M5y
// SIG // LP/ejMIQ5F60PsR2duPoByLRl1kIT2vmeDuW1+v7dhSn
// SIG // L3Qul4tCuXMcyiPQGo6AdAFtKdyvtxbVzb2z2RS+xD/Q
// SIG // J45bMRE7ND2cGbBkn8F5cFBOuca3ZQMIdH43fwVUTK6z
// SIG // ZMgkN/h6t7wXVZgA1HEypsgEEqih9+f9UJHEJrS0Qywr
// SIG // C3d0GKCdndL+cOrfAZ5vk9NYjl0cyc0swgDoXA+1ZlFe
// SIG // LOeg89VDr5ifIDWMHYFRT+Iq7iWVITpLSlT5Lk1YrGIR
// SIG // mS+pCMCUiFJz3ukWJCoQvwmeoYIXdzCCF3MGCisGAQQB
...
// SIG // BAIBBQAEIOAlh6mVssgKbPGFS/2NgJeL+tARxm1DhuX3
// SIG // dfeXePEcAhEA7FYjo/d1zCiV66Hcao1+QxgPMjAyNjA5
...
// SIG // 2E9CZqykgkjms2nEOTAvBgkqhkiG9w0BCQQxIgQgT4MZ
// SIG // Y9k+htXgZ8+hGNIFV3EZDAfWwW1LQ29BwsTxrq8wNwYL
// SIG // KoZIhvcNAQkQAi8xKDAmMCQwIgQgLaCdp/QTH5/nLbbF
// SIG // 5unJZWdVrwQ/HqdCzA0hIOFB6/wwDQYJKoZIhvcNAQEB
// SIG // BQAEggIADlOkhAOH3D/OaE7y0KXxCeKAxK1DFlqzp4m4
// SIG // 9j0k/E4pLEQrN7E9T9PlUsxw4fAwWXQzyvOY16qG5vtW
// SIG // iJdQxQUjn9xXEK4ef0ReakMk5rI1TFlJU9JBG98rE6/g
// SIG // lw2h33P+4vusk1YV6NbwcEw1uGOfXr5ovbyZB52El0P0
// SIG // DBJbRqhd5QbZ1gnr2PGRwCqdE8+gxqb0EB7o7yX2gVWQ
// SIG // aiyxr77udaeyemOUPq6Bbd3nMfFaXTPlDEvzg+dcuY+y
// SIG // cIJUFFzjvomtARuQHC1r0tLqav5PzGDUmvdls/vjf6Yq
// SIG // yfXoQ3oKKF5DCcon0wVRsjpRPtZZBFHdMoYHEsGhncVC
// SIG // bhVojwCXhjtr8+H68yhSCdwEjUwKxNRwJbq4px/ziJMC
// SIG // 3nDofaPtLMzl+TFpQVxS3yp96NgdnRkbgpY0x5iASC5R
// SIG // NY1StlF/3VRGQePvWLM1XwLgsYXv0T3vBIF/C7FAx7Ji
// SIG // 9iCfZlamBdSlP1L2DB2xfjP7BaKeBwINBUz9fU90yEKI
// SIG // vfOMzznJCTOcUoxwjqB30+gTU4mLLWMTsyB2GLgwCRHe
// SIG // fYCM/1P54pOP3Q1UtaQYxGJn2y2bMwuvIvkSJ/HcYUgb
// SIG // vLzX9OlcuV2phZgvzjAla7X9+DDgEZ3pLC63iUicfB7B
// SIG // Ta2FR4jibVsf6hV5FXHj0dWroE2Ql4I=
