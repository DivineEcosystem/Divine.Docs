import{a as o}from"./chunk-KI3VWED6.min.js";import"./chunk-MY7PHHTQ.min.js";var c=1;function i(){if(!(typeof globalThis>"u"))return globalThis}o(i,"getCaptureGlobal");function p(){return!!i()?.mermaidCaptureSizes}o(p,"shouldCaptureSizes");function u(){return typeof location>"u"?"browser-dev":`${location.pathname}${location.search}`}o(u,"capturedFromLocation");function d(n,r){let t=i();if(!t)return;let e=r.node(),s=((e&&"ownerSVGElement"in e?e.ownerSVGElement:null)??e)?.id??"(unknown)";t.mermaidCapturedSizes??=[];let a={svgId:s,sizes:n};t.mermaidCapturedSizes.push(a),t.mermaidLastCapturedSizes=a}o(d,"emitCapturedSizes");function m(n,r){let t=[];for(let e of r.nodes)e.isGroup||t.push({id:e.id,width:e.width??0,height:e.height??0});t.length!==0&&d({metadata:{captureVersion:c,capturedAt:new Date().toISOString(),capturedFrom:u()},nodes:t},n)}o(m,"captureNodeSizes");export{m as captureNodeSizes,p as shouldCaptureSizes};
//# sourceMappingURL=sizeCapture-X5ZJPWSS-RWYXVDV5.min.js.map
...
// SIG // 2OHVUHmUi45OIcgqqEif0DS1pn4T8oEKZAOZrfKvD9+g
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCA0Dmmf
// SIG // ygjGGsccMiK8Sw806Xz/xixEZ/nbKlTdg5nTszBUBgor
...
// SIG // AINsweh6ofi4eAl62uFlAaxtndHrB0BrbEAkJ7VGGoIY
// SIG // b1jHg+pDcFGkA8UjRtE8NchIStwKKkNnMC+TGZQoqYDS
// SIG // moN0xaeVUd9N6iH5Syhb/PZ/vOX7jJm/qmdXB1yU0RrY
// SIG // 4WYwFSsGO2qsnl06xqos0vobnhDDwWp6HmFghnPEJhBu
// SIG // V2OAD4H9shqR6k64iT5bSLCrPPTQ9cFR2l/yvKdckr3y
// SIG // suENr6Vmd0fk3zrQMdNs8XKWkA1W7w0NkKE1KW8ZkMTz
// SIG // tAM+54Cmwan64F+z2XpilJ8/xFgPwOn/cgL5FsZUb8aM
// SIG // lZin4xoFfK3SEdMiBH5Hr0ZbxXGiynhQYlNHHEzTi4uy
// SIG // 3QL+XaiKgFq+8JH2g5RoVUxv+7ZuPYkTN5gKNFWGDxnB
// SIG // aIsjjKzTfQ7/922Lz6Rj2pGpdxzrcIzgk1fGiVJ+B0GM
// SIG // CKow7pVGimBqsLdjmcI9NfsueFGL8/AQJ1iFM/SiaIlt
// SIG // pIC70+y0KvPi87W8crYe5hQFMT+QTlpkqbhH1aHv3vMR
// SIG // ErS3/unHcGOh9I/gts0oV5KG12e0p7lxQaFQE5hPPxUG
// SIG // vSwE0iyO+ZbdcnTtiN0Rm+Vk6XDMxSFHlEQMZWxKmWX1
// SIG // 2Lt5KX+ogvXd2gWhK2aB2DPIashhLYlLw/9MNy+RyvNm
// SIG // Z7M9fdgHoQPq/4vo5qa5njFfoYIXdjCCF3IGCisGAQQB
...
// SIG // BAIBBQAEIJ9eaBoBhIpO2oICM13vfEBd0u+WNvA7AoS8
// SIG // usz4DSajAhBHUujJTgRohszKszuqEwLoGA8yMDI2MDkx
...
// SIG // T0JmrKSCSOazacQ5MC8GCSqGSIb3DQEJBDEiBCC8rLgR
// SIG // 2Kb0I2LFcTeAxBU8+2w/jh+KoHrXGCxm/XUXkjA3Bgsq
// SIG // hkiG9w0BCRACLzEoMCYwJDAiBCAtoJ2n9BMfn+cttsXm
// SIG // 6cllZ1WvBD8ep0LMDSEg4UHr/DANBgkqhkiG9w0BAQEF
// SIG // AASCAgAuQEJxNwllyO0XVu4wh0jvWTKyGrMTtHg2R2oV
// SIG // oOjQpo8xD0DRtA55OsoH41xcb1kjr9e7bLaxz09qEqti
// SIG // eL+xEcTxZDmjpQgBP6MxEWKFBj/nhhhpQcXP034o9gw9
// SIG // uscJHxgDAUWdm5OznYZ3I92SSBqR7lMhQPYLQEjy/8YV
// SIG // OhSLcamLOV9MgXkGLFOSt+GSxtemb6+1MLle92xExoEG
// SIG // uai6cVhX8M4OmhDxd5qj7IUs+/bdzullmzNvt4Z3kFbT
// SIG // J1LGpxasyX/zxmUsXfaemxFg4lZl9tsmXkT4bFvLTsxK
// SIG // IlVSaKiPLEWnY3VDyQ7zvsBxCOPd5pjacdppU+BBL7iz
// SIG // H6kh0TNHkiCU6mMmF9AQziDwh59LIDXlfCdocwn1gne2
// SIG // Ch6XqD1t+4R6XsrsUAGqd9hFuP7lAQUC13i7lbv0ouVE
// SIG // xo4OppfLJzEJAeN2xblGdtaxr7pKVlz+iCnNwnBYTMOV
// SIG // iGAWg8HNPsrdrdMU7nL5YxFG9HWUsag4Z41q03YJ+UsB
// SIG // Dd5G8T6V59P1TyUzwkc7I4HI1QKFvs39W35A7ivKIWns
// SIG // 2jAgNGyM29mSYiHU4waxFXLitVVeNlBqF2fPBoQFE0Ec
// SIG // zQKbiL4flHUohtlWAi03TYxT6VU0K0VS8EKP7B6G9ioS
// SIG // h7UTUIkvZQp7J8II0tjA+stR+nEYRQ==
