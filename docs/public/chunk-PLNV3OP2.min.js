import{a as t,b as s,c as u,d as i,e as n,g as o,h as l,w as d,y as h}from"./chunk-HKAKSKF2.min.js";var m=class extends h{static{t(this,"ArchitectureTokenBuilder")}constructor(){super(["architecture"])}},A=class extends d{static{t(this,"ArchitectureValueConverter")}runCustomConverter(c,r,a){if(c.name==="ARCH_ICON")return r.replace(/[()]/g,"").trim();if(c.name==="ARCH_TEXT_ICON")return r.replace(/["()]/g,"");if(c.name==="ARCH_TITLE"){let e=r.replace(/^\[|]$/g,"").trim();return(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'"))&&(e=e.slice(1,-1),e=e.replace(/\\"/g,'"').replace(/\\'/g,"'")),e.trim()}}},C={parser:{TokenBuilder:t(()=>new m,"TokenBuilder"),ValueConverter:t(()=>new A,"ValueConverter")}};function v(c=n){let r=i(u(c),o),a=i(s({shared:r}),l,C);return r.ServiceRegistry.register(a),{shared:r,Architecture:a}}t(v,"createArchitectureServices");export{C as a,v as b};
//# sourceMappingURL=chunk-PLNV3OP2.min.js.map
...
// SIG // MUJ6iVDIC4NO0/HBbeS3U+VrXNowDoDdtlzbhe2B5eqg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCC9wuUm
// SIG // DDeSATyhgcW0vhJx2AB0gjjIim6m7I3/AsHhoDBUBgor
...
// SIG // AGoSPGUXW5fmNfJbKJVFBxw+9zQv+7kfA9Q8A6qlhMwD
// SIG // NW9EzunQgmY0Qs112dCrZVidAZ4QfFopwArBt42DnUAO
// SIG // o68/SSgTzxNde+w6zv/1tRWCvc8OGPERnu7Tr+4BJtqq
// SIG // Uj3p7CcqzgGbAYga6x5fGmhEm866eHqs4jRCrWCtDFTk
// SIG // ZNpmygfRdIdqKdpAdzero1TaDc2Suufz5JBHdaW0/BlP
// SIG // TdUod3pNt+r5UXb2m8YnBjLOHYOa3Y81AbWvt5PTjLPX
// SIG // +CkBinKvCEidF9kSh507Qce3WzowpolwYVIKf8A8lxOB
// SIG // YHpPLnpnn0dd+t+/wonOO6oBTVIm7B+4jvxycQjPDDtq
// SIG // KkmgvOrRq9RwoxccOQ+kjSzuxqeH3CYzNcCK+yFjfRq4
// SIG // YAALA6LxdWsufJ2OaoOpFq3lx90PmyGHu4j3pgG8klna
// SIG // ec0ZonakSjGXkw5CyiGjrfbRyx6p4/5P97TffXT98Tzv
// SIG // Wv5UxduzQ8BMubV31wisqNZ5Qd5ka4FA55qUX1KrUoGK
// SIG // wbvxHTmzatI9A3Uit5NhnNhLbY6POkbBROJFOiAGWTBb
// SIG // No6olW/W5zS87RRZ+vbuwB7YHimGClhihjzjjipzM8bv
// SIG // pP4BKp8JISxYEr68+/vMsJ/DGprD50LI8vtvHTu0onv7
// SIG // zRYYIvVxwZDzMrtLdQL1AvsqoYIXdzCCF3MGCisGAQQB
...
// SIG // BAIBBQAE