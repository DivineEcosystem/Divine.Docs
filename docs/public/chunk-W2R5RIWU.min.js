import{a as t,b as s,c as o,d as a,e as m,g as d,u as c,w as u,y as T}from"./chunk-HKAKSKF2.min.js";var l=class extends u{static{t(this,"TreeViewValueConverter")}runCustomConverter(r,e,n){if(r.name==="INDENTATION")return e?.length||0;if(r.name==="QUOTED_NAME")return e.substring(1,e.length-1);if(r.name==="BARE_NAME")return e.replace(/[\t ]+$/,"");if(r.name==="CLASS_ANNOTATION")return e.trim().substring(3).trim();if(r.name==="ICON_ANNOTATION"){let i=e.trim();return i.substring(5,i.length-1)}if(r.name==="DESC_ANNOTATION")return e.trim().substring(2).trim()}},N=class extends T{static{t(this,"TreeViewTokenBuilder")}constructor(){super(["treeView-beta"])}},V={parser:{TokenBuilder:t(()=>new N,"TokenBuilder"),ValueConverter:t(()=>new l,"ValueConverter")}};function v(r=m){let e=a(o(r),d),n=a(s({shared:e}),c,V);return e.ServiceRegistry.register(n),{shared:e,TreeView:n}}t(v,"createTreeViewServices");export{V as a,v as b};
//# sourceMappingURL=chunk-W2R5RIWU.min.js.map
...
// SIG // SYVkWqMratNcxvUmRJSfJbKW2TlQQkYGE4zK6j2b6FGg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCa8dur
// SIG // X7R9wG9a3meH4JC+vh7i86hmg+Cem1XjXABSSjBUBgor
...
// SIG // AIzhPNJxt7jmR8pf9cc0DQK6ZbKzgphsLR3WcuVeEhkH
// SIG // XA1q+ft3ItC1+qqh0oRvfMSoXgVWtw/BSV96qqOXqKGr
// SIG // oevjISNk4WNUxLktOBhN37UMyKDGVhZvkE785miEIFYC
// SIG // jtre/bL396hnJS89S+t2rJFh+0AxrNJiuCIX3e72B9JO
// SIG // 4E2OmwRJ2lsTqQfRijIJfzvVHvr+2/cQIrcEKdaxDtHZ
// SIG // npCTU2yu9OpHiGDYkZkqF47/NkDAyXsMf7lKRXUHpLe3
// SIG // EmZl38h32N0L0nFYz/6K9mkICQt9gziBXC9dHIK55OS+
// SIG // 0AUt+UBc2Cscupv9F7AaU5XGmIv9wiG5LCT/iEBgmjhX
// SIG // 6iDaZfwbfh7vNm6uKg6Yt3xEBR3y41m44eYriEwK/RAP
// SIG // BPSRNzg/zx1qAY0ZKOHnhuEq6B5QVQ5wWlCWCgeTwVrh
// SIG // 4V4j4CFKEgPoFe/6x6a9vpqRgM6FglCddLOfGubkXsP2
// SIG // j0aAckitJR8VpD0tlWotURWz25TyLcr4gKNFIXbwmxyh
// SIG // CFrBlU5EDTfQZpElrcTPOJPWEe7IuCaajksNmlgPmCk4
// SIG // 32+BXabUDjQCeYZF2EMcDYtobcjj5BHXYmGVsRqEvgiE
// SIG // 0bgq4TitgzCygBkFKmDGEbX+cWh7hsN0HSW4REKYShxg
// SIG // 0G1TRegXK/S1Bgrk1k8lOt8goYIXdjCCF3IGCisGAQQB
...
// SIG // BAIBBQAEIFLb4foZSH4/ImjXX34isCQn2y7JbOWKaGdU
// SIG // MAtC9CuQAhAiy/P0ECJuasrVapyjhDILGA8yMDI2MDkx
...
// SIG // T0JmrKSCSOazacQ5MC8GCSqGSIb3DQEJBDEiBCANh+aj
// SIG // ei81/GvB1czr/Id0DVeMUx3CVH8Pnx9u/JG7UzA3Bgsq
// SIG // hkiG9w0BCRACLzEoMCYwJDAiBCAtoJ2n9BMfn+cttsXm
// SIG // 6cllZ1WvBD8ep0LMDSEg4UHr/DANBgkqhkiG9w0BAQEF
// SIG // AASCAgCQomOaRRP01nwaIv9MI3LoJW1fEFBZlQiFKeGu
// SIG // THtXf1iJvJ8/+6cItVf5KBOGP7Ew0LLZy/JZOlh1i9y4
// SIG // SuS3vFrRtzASDG4NGjWbFcrYChur6FlV+1qibPUGdION
// SIG // ITYWZ3ZFKokJfR1wC4jtdLd9JJyY/5bHvJva0g2CcOSU
// SIG // nGIBbM0+yoz/GlglDO2jOUESHSqOWCn7avQz27W1dlKi
// SIG // f6/wKex8TBBCULacAz7ikZhQTEZzF7YYTTZEEslMWC6W
// SIG // t9SiJ77liHqOmX+xuAp6CUq/jtJl6sTx4rP4qZMFTUVP
// SIG // dseAQa0Yu0kiKoqAYKBGw3RqztA8agdOBR4tjzCrypW+
// SIG // HAMXKXcCj+JIRProHyPbWxbmy1Q6k7/fIyOmlro10NAu
// SIG // Yun0GDIM2CQNLMt+mjRu8lFbov1vwzDP232wRQzEabBs
// SIG // npkj44Lw9ySikju/9G32jKn2Yhtxlbxq9mi1961XNEXd
// SIG // UTFmFVBKTS4Z/te227P7fOxHEYeTFPQrZILfDRucBfXU
// SIG // HxiwwokFnyR+E5oUA9Hi671vhX2EvE9f4RvdCoymOTk7
// SIG // djJdak4R7KUbvsiwL1RUlEmwYmLAiGA0geZmZ94/t3xd
// SIG // p2sowG84JEvPRIYEBXA+4cbRIQ86A1kJSKaJPHaRczTJ
// SIG // n32ontWzpBRDOdP08XxeBEL1HaecQQ==
