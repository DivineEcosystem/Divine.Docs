import{a,b as m,c as p}from"./chunk-5N7VESPF.min.js";import{a as s}from"./chunk-B74SLRLD.min.js";import"./chunk-2GHZB4JL.min.js";import{b as l}from"./chunk-Q2RQ4CEB.min.js";import{b as i}from"./chunk-EG7DXP2I.min.js";import"./chunk-CE4TH2HP.min.js";import"./chunk-GD5LB6TO.min.js";import"./chunk-22P4TOB3.min.js";import"./chunk-W2R5RIWU.min.js";import"./chunk-PLNV3OP2.min.js";import"./chunk-WJAIEDLJ.min.js";import"./chunk-225PYD3O.min.js";import"./chunk-RJJLLGSV.min.js";import"./chunk-ETZPTOBJ.min.js";import"./chunk-WCKTNQ54.min.js";import"./chunk-RJT23JEV.min.js";import"./chunk-YA245SZB.min.js";import"./chunk-IMOGEAU7.min.js";import"./chunk-APDCPYLU.min.js";import"./chunk-HKAKSKF2.min.js";import"./chunk-ATRUDZZQ.min.js";import{b as n}from"./chunk-AQCTVUUU.min.js";import{a as t}from"./chunk-KI3VWED6.min.js";import"./chunk-MY7PHHTQ.min.js";var f=i().RailroadPeg.parser.LangiumParser,c=t(e=>{let r=e.alternatives.map(d);return r.length===1?r[0]:{type:"choice",alternatives:r}},"transformOrderedChoice"),d=t(e=>{let r=e.elements.map(P);return r.length===1?r[0]:{type:"sequence",elements:r}},"transformSequence"),P=t(e=>{let r=g(e.suffix);return e.operator?{type:"special",text:e.operator==="&"?`&${u(r)}`:`!${u(r)}`}:r},"transformPrefix"),u=t(e=>{switch(e.type){case"terminal":return`"${e.value}"`;case"nonterminal":return e.name;case"special":return e.text;default:return"(...)"}},"nodeToLabel"),g=t(e=>{let r=v(e.primary);if(!e.operator)return r;switch(e.operator){case"?":return{type:"optional",element:r};case"*":return{type:"repetition",element:r,min:0,max:1/0};case"+":return{type:"repetition",element:r,min:1,max:1/0};default:throw new Error(`Unsupported PEG suffix operator: ${e.operator}`)}},"transformSuffix"),v=t(e=>{switch(e.$type){case"PegLiteral":return{type:"terminal",value:e.value};case"PegIdentifier":return{type:"nonterminal",name:e.name};case"PegGroup":return c(e.element);case"PegAny":return{type:"special",text:e.dot};default:throw new Error(`Unsupported PEG primary node: ${e.$type}`)}},"transformPrimary"),y=t(e=>({name:e.name,definition:c(e.definition)}),"transformRule"),h=t(e=>{s(e,a),e.title&&a.setTitle(e.title),e.rules.map(r=>a.addRule(y(r)))},"populateDb"),b={parse:t(e=>{a.clear(),n.debug("[PEG Parser] Starting Langium parse");let r=f.parse(e);if(r.lexerErrors.length>0||r.parserErrors.length>0)throw new l(r);let o=r.value;n.debug("[PEG Parser] Parsed rules:",o.rules.length),h(o),n.debug("[PEG Parser] Parse complete")},"parse"),parser:{yy:a}},R={parser:b,db:a,renderer:p,styles:m};export{R as diagram};
//# sourceMappingURL=pegDiagram-VL7TDLO6-GTH4N24V.min.js.map
...
// SIG // Ekk/6YWMLXX/D7kAbpViXiCyCAQTZLMegDxYRfPJ2TOg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCA23Zd1
// SIG // TC6fZ7DppBI7ErRYOhvVMBu8GDct2cHSNZVMqjBUBgor
...
// SIG // AETvDGXP6Drsfd6AkLcqRuomWoDlkL+jfokDoZFcONM9
// SIG // npVIfWeS4NenjDXxw44Cw0cySiVBKkSJBUO66UV+vkYT
// SIG // Dnj7NBABcBiqD+vog0ec2pgwtEoAAdfEMZ5q2D/GqOld
// SIG // isY5w4B5KHRN/dDI8mrEZYXJlJg2dCea7jtk2nAFbX8G
