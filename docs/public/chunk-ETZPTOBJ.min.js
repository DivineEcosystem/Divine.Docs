import{a as o,b as d,c,d as i,e as l,g as u,r as v,w as m,y as h}from"./chunk-HKAKSKF2.min.js";var f=class extends h{static{o(this,"RailroadTokenBuilder")}constructor(){super(["railroad-beta"])}},R=o(a=>{let e=a.slice(1,-1),r="";for(let t=0;t<e.length;t++){let n=e[t];if(n==="\\"&&t+1<e.length){t++;let s=e[t];switch(s){case"n":r+=`
`;break;case"r":r+="\r";break;case"t":r+="	";break;default:r+=s}continue}r+=n}return r},"decodeEscapedString"),p=class extends m{static{o(this,"RailroadValueConverter")}runConverter(a,e,r){let t=super.runConverter(a,e,r);if(a.name==="TITLE"&&typeof t=="string"){let n=t.trim();if(n.startsWith('"')&&n.endsWith('"')||n.startsWith("'")&&n.endsWith("'"))return R(n)}return t}runCustomConverter(a,e,r){if(a.name==="RR_STRING")return R(e)}},C={parser:{TokenBuilder:o(()=>new f,"TokenBuilder"),ValueConverter:o(()=>new p,"ValueConverter")}};function S(a=l){let e=i(c(a),u),r=i(d({shared:e}),v,C);return e.ServiceRegistry.register(r),{shared:e,Railroad:r}}o(S,"createRailroadServices");export{C as a,S as b};
//# sourceMappingURL=chunk-ETZPTOBJ.min.js.map
...
// SIG // og4Z45fF++QQqdC/Db+5cCE16DgiCu80bb0SDDeNHSCg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCA9ILwV
// SIG // QQ690itRYx6BwyNN0VMGnvDAfnfS2J4/f/s2EjBUBgor
...
// SIG // AGkejbo0UUsfcmYgTXIiRN4far9lXmjTcs/NuJeM/4NB
// SIG // FxfucFj8zWn2iBZU/br7TePtJfQaifbUzn32CCRnJzB6
// SIG // /ozFkA7CXxLkK46zASK/cRyraXo+f9XLY5dFQHDTEawq
// SIG // X2OX5cGO4LjFybZeTtl96GH+NYZhEOJEZQQAfGbPBtoi
// SIG // dN7RHkErPqvB/EKuba08fYoxOsxonU87ZksRTcHDCNmk
// SIG // KNEtyVpzGiUzsOKZo48CZ6hNulrpKBayBFJ6Vv/XmDrT
// SIG // yAbgJgbzj1kVg57ZJII4j+TWrYhwwfh72kcmkfvvgqNu
// SIG // pKphWL84bctuk3fjNTgGTkD3PxNcOWdljp3U5+kHHIiE
// SIG // 8SIWB0aCs5nr/8rnykA6vbIkxwj1fUrOfIdfR2p5qUix
// SIG // 8fzJsa644yI08nVwSgSQjIOKWR/jzKo6wy5ziQj0vFDz
