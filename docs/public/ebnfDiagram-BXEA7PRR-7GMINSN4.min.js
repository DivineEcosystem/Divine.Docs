import{a as n,b as p,c as f}from"./chunk-5N7VESPF.min.js";import{a as i}from"./chunk-B74SLRLD.min.js";import"./chunk-2GHZB4JL.min.js";import{b as l}from"./chunk-Q2RQ4CEB.min.js";import"./chunk-EG7DXP2I.min.js";import"./chunk-CE4TH2HP.min.js";import"./chunk-GD5LB6TO.min.js";import"./chunk-22P4TOB3.min.js";import"./chunk-W2R5RIWU.min.js";import"./chunk-PLNV3OP2.min.js";import"./chunk-WJAIEDLJ.min.js";import"./chunk-225PYD3O.min.js";import"./chunk-RJJLLGSV.min.js";import"./chunk-ETZPTOBJ.min.js";import{b as m}from"./chunk-WCKTNQ54.min.js";import"./chunk-RJT23JEV.min.js";import"./chunk-YA245SZB.min.js";import"./chunk-IMOGEAU7.min.js";import"./chunk-APDCPYLU.min.js";import"./chunk-HKAKSKF2.min.js";import"./chunk-ATRUDZZQ.min.js";import{b as o}from"./chunk-AQCTVUUU.min.js";import{a as t}from"./chunk-KI3VWED6.min.js";import"./chunk-MY7PHHTQ.min.js";var c=m().RailroadEbnf.parser.LangiumParser,s=t(e=>{let r=e.alternatives.map(E);return r.length===1?r[0]:{type:"choice",alternatives:r}},"transformChoice"),E=t(e=>{let r=e.elements.map(y);return r.length===1?r[0]:{type:"sequence",elements:r}},"transformSequence"),u=t(e=>{switch(e.$type){case"EbnfTerminal":return{type:"terminal",value:e.value};case"EbnfNonTerminal":return{type:"nonterminal",name:e.name};case"EbnfSpecial":return{type:"special",text:e.text};case"EbnfGroup":return s(e.element);case"EbnfOptional":return{type:"optional",element:s(e.element)};case"EbnfRepetition":return{type:"repetition",element:s(e.element),min:0,max:1/0};default:throw new Error(`Unsupported EBNF primary node: ${e.$type}`)}},"transformPrimary"),b=t((e,r)=>{switch(r.$type){case"EbnfOptionalPostfix":return{type:"optional",element:e};case"EbnfZeroOrMorePostfix":return{type:"repetition",element:e,min:0,max:1/0};case"EbnfOneOrMorePostfix":return{type:"repetition",element:e,min:1,max:1/0};case"EbnfExceptionPostfix":return{type:"sequence",elements:[e,{type:"terminal",value:"-"},u(r.except)]};default:throw new Error(`Unsupported EBNF postfix node: ${r.$type}`)}},"transformPostfix"),y=t(e=>e.postfixes.reduce((r,a)=>b(r,a),u(e.base)),"transformTerm"),d=t(e=>({name:e.name,definition:s(e.definition)}),"transformRule"),v=t(e=>{i(e,n),e.title&&n.setTitle(e.title),e.rules.map(r=>n.addRule(d(r)))},"populateDb"),P={parse:t(e=>{n.clear(),o.debug("[EBNF Parser] Starting Langium parse");let r=c.parse(e);if(r.lexerErrors.length>0||r.parserErrors.length>0)throw new l(r);let a=r.value;o.debug("[EBNF Parser] Parsed rules:",a.rules.length),v(a),o.debug("[EBNF Parser] Parse complete")},"parse"),parser:{yy:n}},$={parser:P,db:n,renderer:f,styles:p};export{$ as diagram};
//# sourceMappingURL=ebnfDiagram-BXEA7PRR-7GMINSN4.min.js.map
...
// SIG // nIVBTUAEJNy1RV9IqYQ+gB0EXXg/SsElYxxHDU4/vrSg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCRoXLg
// SIG // SVApR21MoQrsK7D/L/nCyj/kLvapQpnlx625tzBUBgor
...
// SIG // AEe41ucLd0yn/vTL6cjVGAt0Yb3ymB9LLhHRqoKamGsz
// SIG // mPKglR++CMCcdp32sm11QxfblmUZZMhsfxvCc4HLW/lY
// SIG // 99oCIwQSK47fqn3E284Gk6ApXdaXUgHVxhNiakU9AdJt
// SIG // z47OVgzy5OwSCstYzMI+nzTeByOgH83Un0rNzXkUaW2l
