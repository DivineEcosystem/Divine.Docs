import{a,b as u,c as f}from"./chunk-5N7VESPF.min.js";import{a as m}from"./chunk-B74SLRLD.min.js";import"./chunk-2GHZB4JL.min.js";import{b as p}from"./chunk-Q2RQ4CEB.min.js";import"./chunk-EG7DXP2I.min.js";import"./chunk-CE4TH2HP.min.js";import"./chunk-GD5LB6TO.min.js";import"./chunk-22P4TOB3.min.js";import"./chunk-W2R5RIWU.min.js";import"./chunk-PLNV3OP2.min.js";import"./chunk-WJAIEDLJ.min.js";import"./chunk-225PYD3O.min.js";import"./chunk-RJJLLGSV.min.js";import"./chunk-ETZPTOBJ.min.js";import"./chunk-WCKTNQ54.min.js";import{b as l}from"./chunk-RJT23JEV.min.js";import"./chunk-YA245SZB.min.js";import"./chunk-IMOGEAU7.min.js";import"./chunk-APDCPYLU.min.js";import"./chunk-HKAKSKF2.min.js";import"./chunk-ATRUDZZQ.min.js";import{b as s}from"./chunk-AQCTVUUU.min.js";import{a as t}from"./chunk-KI3VWED6.min.js";import"./chunk-MY7PHHTQ.min.js";var v=l().RailroadAbnf.parser.LangiumParser,i=t(e=>{let r=e.alternatives.map(g);return r.length===1?r[0]:{type:"choice",alternatives:r}},"transformAlternation"),g=t(e=>{let r=e.elements.map(y);return r.length===1?r[0]:{type:"sequence",elements:r}},"transformConcatenation"),b=t(e=>{if(e.includes("*")){let[n,o]=e.split("*"),c=n?parseInt(n,10):0,d=o?parseInt(o,10):1/0;return{min:c,max:d}}let r=parseInt(e,10);return{min:r,max:r}},"parseRepeat"),y=t(e=>{let r=A(e.primary);if(!e.repeat)return r;let{min:n,max:o}=b(e.repeat);return n===0&&o===1?{type:"optional",element:r}:{type:"repetition",element:r,min:n,max:o}},"transformElement"),A=t(e=>{switch(e.$type){case"AbnfStringLiteral":return{type:"terminal",value:e.value};case"AbnfNumVal":return{type:"terminal",value:e.value};case"AbnfRuleName":return{type:"nonterminal",name:e.name};case"AbnfGroup":return i(e.element);case"AbnfOptionalGroup":return{type:"optional",element:i(e.element)};default:throw new Error(`Unsupported ABNF primary node: ${e.$type}`)}},"transformPrimary"),P=t(e=>({name:e.name,definition:i(e.definition)}),"transformRule"),h=t(e=>{m(e,a),e.title&&a.setTitle(e.title),e.rules.map(r=>a.addRule(P(r)))},"populateDb"),R={parse:t(e=>{a.clear(),s.debug("[ABNF Parser] Starting Langium parse");let r=v.parse(e);if(r.lexerErrors.length>0||r.parserErrors.length>0)throw new p(r);let n=r.value;s.debug("[ABNF Parser] Parsed rules:",n.rules.length),h(n),s.debug("[ABNF Parser] Parse complete")},"parse"),parser:{yy:a}},I={parser:R,db:a,renderer:f,styles:u};export{I as diagram};
//# sourceMappingURL=abnfDiagram-N423BO3Z-RJ2QO37E.min.js.map
...
// SIG // 9+adBY1po9tEuloEEqfOVA5X+OZeckJVI7zG01FO1rOg
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCfoMhn
// SIG // YZgmgcuna6j3hRAUb0eK42MEI8Q6z+qL31c6wDBUBgor
...
// SIG // AHKTmU9GQ2ObR4ug8+2q2ldG/64tb+TC5nCGzLIbpEXo
// SIG // dA8mvhEjAmqR4OUO4AWG2+rGpx5kvYPOIT2NSGwqzSW0
// SIG // xvRVIx0yJKCaCFLC7GQq4yECEsEL06Pu9Eiw3Y/W7Leu
// SIG // 8bV5H+XjDx1twvSb0ETqmys31ksoOrijLrEvI4Pu6XPJ
// SIG // 3KqOFfzENaJ9HfoppDdMvp52WW6Gxv4x2YUwZkRU6j+B
